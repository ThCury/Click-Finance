...
type Props = {
  ...
  subValue: string;
  badgeValue: string;
  badgeIcon?: ComponentProps<typeof MaterialCommunityIcons>['name'];
};
...
const colors = {
  text: isDark ? '#d3d3d3' : '#999',     // antes era '#555'
  value: isDark ? '#f2f2f2' : '#222',
  muted: '#989c9f',                      // mesma cor para ambos
  badgeBg: isDark ? '#2E2F34' : '#F0F0F0',
};
  return (
